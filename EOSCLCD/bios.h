...
//
#if 1//jdb2018-09-03
#define	B_PRI_DBLH			2	//    PRN_DBLH_Mode
#define	B_PRI_RON			1	//    PRN_RECEIPT_Mode
#define	B_PRI_JON			0	//    PRN_STUB_Mode
#define	B_PRI_GRAF			4	//    PRN_GRAPHIC_Mode
#define	B_PRI_FCUT			5	//    PRN_CUTF_Mode
#define	B_PRI_PCUT			5	//    PRN_CUTH_Mode
#else
...
extern WORD Bios_PortWrite(BYTE NumCom, BYTE *TxData, WORD NumBytes, BYTE Flags);//jdb2018-09-02
...
/** @addtogroup USBD_USER
  * @{
  */
#define USB_NONE        0   //ccr USB????
#define USB_DISK        1   //ccr USB???
#define USB_KEYBOARD    2   //ccr USB????,???
