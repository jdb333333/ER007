...
BYTE SelfGrpReady;        //ccr2018-02-01自定义图片是否转换好了
struct GRAPH_DEFINE InfoSelf_Graph;//用户自定义图片
BYTE Self_Graph[SELFGRASIZE];//用户自定义图片

//ccr2017-08-09>>>条码图片存放区>>>
//#if BARCODESIZE
//struct GRAPH_DEFINE InfoBarCode_Graph;
//BYTE BarCode_Graph[BARCODESIZE];
//#endif
//ccr2017-08-09<<<<<<<<<<<<<<<<<<<
...
/////////////////////////////////////////////////////////////////
PRNSTATUS Prn_Status;   //Status of current for Inter(打印机在打印时的状态)
PRNSTATUS Printer_Status;//用来向应用cen层提供打印机的当前状态
...
WORD Prn_VNTCR;
SCHAR Prn_TaskNow = -1;  //task num current
...
CONST BYTE * Graphic_Data[GRAPHICMAX]={
    ...
    photo_data_ITALIA,
#elif defined(CASE_GREECE)
    photo_data_MALTA,
#else
    photo_data_panama,
#endif
#if (BARCODESIZE) //|| defined(CASE_QRCODE))
    BarCode_Graph
#endif
};
...
#if (BEATS_PER_CYCLE==4) //CCR 2-2相模式

CONST WORD TAB_PHASEJ[4] = { //    RPH1 RPH2 RPH3 RPH4
...
#if (BEATS_PER_CYCLE==4) //CCR
// BYTE TAB_PHASEJ[] = {0x60,0xC0,0x90,0x30};
CONST ULONG TAB_PRTIME[VMAXSPEED] = { //HJ 马达换相时间
#if (1)
    2890*uSECOND,      //1-
    1786*uSECOND,      //2-
    1381*uSECOND,      //3
...
#else
CONST ULONG TABSTROBE24VB[32] = { //加热定时器的时长最大1072us 远小于步进电机的换步时长 //未使用HJ
			//temperate 	ADC
	uSECOND*60 	,//100, 	0
	uSECOND*60 	,//100, 	1
	uSECOND*60 	,//100, 	2
...
//适配器供电加热参数
CONST ULONG TABSTROBE24V[32][6] = {
//MAX(us) 		<1160			<1020				<920				<840			<780			temperate ADC
uSECOND*95	,uSECOND*92 	,uSECOND*89 	,uSECOND*87		,uSECOND*85 	,uSECOND*83  	, //100	,0
uSECOND*95	,uSECOND*92 	,uSECOND*89 	,uSECOND*87		,uSECOND*85 	,uSECOND*83  	, //100	,1
uSECOND*95	,uSECOND*92 	,uSECOND*89 	,uSECOND*87		,uSECOND*85 	,uSECOND*83  	, //100	,2
uSECOND*124	,uSECOND*121	,uSECOND*117	,uSECOND*114	,uSECOND*111	,uSECOND*109  	, //95	,3
uSECOND*154	,uSECOND*149	,uSECOND*145	,uSECOND*142	,uSECOND*138	,uSECOND*135  	, //90	,4
uSECOND*184	,uSECOND*178	,uSECOND*173	,uSECOND*169	,uSECOND*165	,uSECOND*161 	, //85	,5
uSECOND*214	,uSECOND*207	,uSECOND*201	,uSECOND*196	,uSECOND*191	,uSECOND*189 	, //80	,6
uSECOND*244	,uSECOND*236	,uSECOND*229	,uSECOND*223	,uSECOND*218	,uSECOND*215 	, //75	,7
uSECOND*273	,uSECOND*265	,uSECOND*257	,uSECOND*251	,uSECOND*245	,uSECOND*241 	, //70	,8
