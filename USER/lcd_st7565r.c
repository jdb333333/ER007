...
void ST7565R_IO_Init(void)
{
	...
	//GPIOA: CLK--GPIO_Pin_0, A0--GPIO_Pin_8, SID--GPIO_Pin_3
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_0 | GPIO_Pin_3 | GPIO_Pin_8;
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
	GPIO_InitStructure.GPIO_OType = GPIO_OType_PP;
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_OUT;
	GPIO_InitStructure.GPIO_PuPd = GPIO_PuPd_UP;
	GPIO_Init(GPIOA, &GPIO_InitStructure);
	//GPIOA: CS--GPIO_Pin_10
...
void mInitialLCD(void)
{
	...
	ST7565R_WR_CMD(ST7565R_CMD_ELECTRONIC_VOLUME(0x19/*0x24*/));
