...
__align(32) u8 mem2base[MEM2_MAX_SIZE];//ccr2018-04-10 __attribute__((at(0X64000000)));					//外部SRAM内存池
//内存管理表
u32 mem1mapbase[MEM1_ALLOC_TABLE_SIZE];													//内部SRAM内存池MAP
u32 mem2mapbase[MEM2_ALLOC_TABLE_SIZE];//ccr2018-04-10 __attribute__((at(0X64000000+MEM2_MAX_SIZE)));	//外部SRAM内存池MAP
//内存管理参数	   
