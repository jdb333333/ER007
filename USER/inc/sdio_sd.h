...
/**
  ...
  */
 //因GPIO不够用，使用与USB VBUS复用的GPIOA_9作为SD检测信号 
...
#define  SDBLOCKSIZE             512//ouhs 20180423 (1024-512*BLOCK512)-->512
...
typedef struct
{
  ...
  __IO uint64_t DeviceSize;           //ouhs 20180504 __IO uint32_t DeviceSize;           /*!< Device Size */
