...
//#define BUFFER_SIZE         	0x2000	//定义缓冲区大小,即一次写入的数据
#define NAND_SAMSUNG_MakerID	0xEC	//NAND厂商号
#define NAND_SAMSUNG_DeviceID	0xF1	//NAND器件号
...
#else
/* FSMC NAND memory K9F1G08 parameters */  
...
#define NAND_ZONE_SIZE             ((uint16_t)0x0200) /* 1024 Block per zone */  
