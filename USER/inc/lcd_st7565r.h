...
#define ST7565R_CS_LOW()       GPIOA->BSRRH =	GPIO_Pin_10	// 清位
#define ST7565R_CS_HIGH()      GPIOA->BSRRL =	GPIO_Pin_10	// 置位

#define ST7565R_A0_CMD()       GPIOA->BSRRH =	GPIO_Pin_8	// 清位
#define ST7565R_A0_DATA()      GPIOA->BSRRL =	GPIO_Pin_8	// 置位

#define ST7565R_CLK_LOW()      GPIOA->BSRRH =	GPIO_Pin_0	// 清位
#define ST7565R_CLK_HIGH()     GPIOA->BSRRL =	GPIO_Pin_0	// 置位

#define ST7565R_SID_LOW()      GPIOA->BSRRH =	GPIO_Pin_3	// 清位
#define ST7565R_SID_HIGH()     GPIOA->BSRRL =	GPIO_Pin_3	// 置位
