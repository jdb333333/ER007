...
#define SD_CS_PIN_1ST                   GPIO_Pin_8                 /* PC.08 */
#define SD_CS_GPIO_PORT_1ST             GPIOC                       /* GPIOC */
#define SD_CS_GPIO_CLK_1ST              RCC_AHB1Periph_GPIOC

#define SD_DETECT_PIN_1ST               GPIO_Pin_2                  /* PD.02 */
#define SD_DETECT_GPIO_PORT_1ST         GPIOD                       /* GPIOD */
#define SD_DETECT_GPIO_CLK_1ST          RCC_AHB1Periph_GPIOD

#define SD_CS_PIN_2ND                  	GPIO_Pin_9                 /* PC.09 */
#define SD_CS_GPIO_PORT_2ND            	GPIOC                       /* GPIOC */
#define SD_CS_GPIO_CLK_2ND             	RCC_AHB1Periph_GPIOC

#ifdef CASE_MCR30
#define SD_DETECT_PIN_2ND               GPIO_Pin_8                  /* PG.08 */
#define SD_DETECT_GPIO_PORT_2ND         GPIOG                       /* GPIOG */
#define SD_DETECT_GPIO_CLK_2ND          RCC_AHB1Periph_GPIOG
#endif
...
#define SPIx_TX_DMA_IT_TEIF							DMA_IT_TEIF5
...
#define SPIx_RX_DMA_IT_TEIF							DMA_IT_TEIF0
...
/** 
  ...
  */  
#define SD_CS_LOW()     		GPIOC->BSRRH = GPIO_Pin_8
#define SD_CS_LOW_2ND()     GPIOC->BSRRH = GPIO_Pin_9

/** 
  * @brief  Deselect SD Card: ChipSelect pin high   
  */ 
#define SD_CS_HIGH()    		GPIOC->BSRRL = GPIO_Pin_8
#define SD_CS_HIGH_2ND()    GPIOC->BSRRL = GPIO_Pin_9


//ouhs
#define SD_OK 	SD_RESPONSE_NO_ERROR

#define  SDBLOCKSIZE 	SD_BLOCK_SIZE
