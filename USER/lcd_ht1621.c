...
#define	HT1621_DATA_High()	GPIOA->BSRRL = GPIO_Pin_5
#define	HT1621_DATA_Low()		GPIOA->BSRRH =  GPIO_Pin_5
#define	HT1621_WR_High()	 	GPIOA->BSRRL = GPIO_Pin_15
#define	HT1621_WR_Low()	 		GPIOA->BSRRH =  GPIO_Pin_15
#define	HT1621_CS_High()		GPIOA->BSRRL = GPIO_Pin_4
#define	HT1621_CS_Low()			GPIOA->BSRRH =  GPIO_Pin_4
...
void HT1621_Init(void)
{
	...
	// GPIO_Pin_4--HT1621_CS, GPIO_Pin_5--HT1621_DATA, GPIO_Pin_15--HT1621_WR
