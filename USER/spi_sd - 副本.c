...
uint8_t SD_Detect(void)
{
  ...
  if (GPIO_ReadInputData(SD_DETECT_GPIO_PORT_EXTR) & SD_DETECT_PIN_EXTR)
  {
...
void SD_LowLevel_DeInit(void)
{
  ...
  GPIO_InitStructure.GPIO_Pin = SD_CS_PIN_EXTR;
  GPIO_Init(SD_CS_GPIO_PORT_EXTR, &GPIO_InitStructure);

  /*!< Configure SD_SPI_CS_PIN pin: SD Card CS pin */
  GPIO_InitStructure.GPIO_Pin = SD_CS_PIN_INTR;
  GPIO_Init(SD_CS_GPIO_PORT_INTR, &GPIO_InitStructure);

  /*!< Configure SD_SPI_DETECT_PIN pin: SD Card detect pin */
  GPIO_InitStructure.GPIO_Pin = SD_DETECT_PIN_EXTR;
  GPIO_Init(SD_DETECT_GPIO_PORT_EXTR, &GPIO_InitStructure);
}
